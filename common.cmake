...
#   dashboard_source_name     = Name of source directory (crash)
#   dashboard_binary_name     = Name of binary directory (crash-build)
...
set(dashboard_git_url "git@github.com:malaterre/cmake-crash.git")
endif()
...
if(NOT DEFINED CTEST_SOURCE_DIRECTORY)
  if(DEFINED dashboard_source_name)
    ...
    set(CTEST_SOURCE_DIRECTORY ${CTEST_DASHBOARD_ROOT}/kakadu-voxxl)
  endif()
endif()
...
if(EXISTS ${CTEST_SOURCE_DIRECTORY})
  ...
  if(vcs_refresh AND "${CTEST_SOURCE_DIRECTORY}" MATCHES "/(kakadu-voxxl)[^/]*")
...
while(NOT dashboard_done)
  ...
  if(dashboard_fresh OR NOT dashboard_continuous OR count GREATER 0)
    ...
    if(NOT DEFINED dashboard_no_submit)
